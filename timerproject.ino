...
void digit0 () { // for 0 needed to turn ON F A B C D E segments, so:
digitalWrite(A, HIGH);
digitalWrite(B, HIGH);
digitalWrite(C, HIGH);
digitalWrite(D, HIGH);
digitalWrite(E, HIGH);
digitalWrite(F, HIGH);
digitalWrite(G, LOW); //////////////////////// G segment should be turn OFF
};
...
if (state22 == HIGH)
{ 
  int state25 = digitalRead(25); //10sec
  if (state25 == LOW)
  {
    i=10;
    int idstate25=i;
  ...
  int state26 = digitalRead(26); //24sec
  if (state26 == LOW)
  {
    i=24;
    int idstate26=i;
  ...
  int state27 = digitalRead(27); //1min
  if (state27 == LOW)
  {
    i=100;
    int idstate27=i;
   ...
   int state28 = digitalRead(28); //10min
  if (state28 == LOW)
  {
    i=1000;
    int idstate28=i;
   ...
   int state29 = digitalRead(29); //30min
  if (state29 == LOW)
  {
    i=3000;
    int idstate29=i;
...
if (state23==HIGH)  //pause
  { /*  {int state24 = digitalRead(24);
   if (state24 == LOW)
      { timer++;
        showdigits (i);
     if (timer==228)  //1sec
